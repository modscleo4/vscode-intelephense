/**
 * Thanks to @jdneo - https://github.com/redhat-developer/vscode-java/pull/2354
 */
...
export class PhpInlayHintsProvider implements InlayHintsProvider {
